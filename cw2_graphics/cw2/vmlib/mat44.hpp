...
Mat44f make_rotation_x( float aAngle ) noexcept
{
	return Mat44f{
		{
			1.f, 0.f, 0.f, 0.f,
			0.f, std::cos(aAngle), -std::sin(aAngle), 0.f,
			0.f, std::sin(aAngle), std::cos(aAngle), 0.f,
			0.f, 0.f, 0.f, 1.f
		}
	};
}
...
Mat44f make_rotation_y( float aAngle ) noexcept
{
	return Mat44f{
		{
			std::cos(aAngle), 0.f, std::sin(aAngle), 0.f,
			0.f, 1.f, 0.f, 0.f,
			-std::sin(aAngle), 0.f, std::cos(aAngle), 0.f,
			0.f, 0.f, 0.f, 1.f
		}
	};
}
...
Mat44f make_rotation_z( float aAngle ) noexcept
{
	return Mat44f{
		{
			std::cos(aAngle), -std::sin(aAngle), 0.f, 0.f,
			std::sin(aAngle), std::cos(aAngle), 0.f, 0.f,
			0.f, 0.f, 1.f, 0.f,
			0.f, 0.f, 0.f, 1.f
		}
	};

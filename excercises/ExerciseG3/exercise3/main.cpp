...
#	endif // ~ !NDEBUG
	...
	// Load shader program
	ShaderProgram prog( {
		{ GL_VERTEX_SHADER, "assets/ex3/default.vert" },
		{ GL_FRAGMENT_SHADER, "assets/ex3/default.frag" }
	} );
	...
	while( !glfwWindowShouldClose( window ) )
	{
		...
		// Orbit: rotate first (around origin), then translate to orbit radius
		Mat44f model2world2 = make_rotation_y(orbitAngle) * make_translation({3.f, 0.f, 0.f});
